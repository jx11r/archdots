...
beautiful.init("/home/jx11r/.config/awesome/theme.lua")
...
awful.widget.watch("bash -c 'pamixer --get-mute && pamixer --get-volume'", 1, function(widget, stdout)
  local lines = {}
...
globalkeys = gears.table.join(
  ...
  -- Prompt
  awful.key({ modkey }, "s", function() awful.spawn("rofi -show drun") end,
